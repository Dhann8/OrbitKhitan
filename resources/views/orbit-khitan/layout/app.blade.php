...
<head>
    ...
    <meta name="description"
        content="Orbit Khitan — Khitan modern tanpa jarum suntik. Aman, minim nyeri, cepat pulih. Ditangani dokter berpengalaman. Layanan homecare tersedia.">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link
        href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700;800;900&family=Plus+Jakarta+Sans:wght@400;500;600;700&display=swap"
        rel="stylesheet">
    ...
    <style>
        ...
        .announce {
            background: linear-gradient(90deg, #0F2747, #1d4ed8, #0F2747);
            background-size: 200% auto;
            animation: gradShift 6s linear infinite;
        }

        .hero-ov {
            background: linear-gradient(105deg, rgba(15, 39, 71, .93) 0%, rgba(15, 39, 71, .78) 45%, rgba(37, 99, 235, .2) 100%);
        }
        ...
        .gal-cap {
            ...
            background: linear-gradient(to top, rgba(15, 39, 71, .78) 0%, transparent 55%);
        }
