...
<head>
    ...
    <meta name="description"
        content="Pelayanan medis profesional oleh dr. Cecep Chandra Supriadi, AIFO-K. Khitan Modern, Homecare, dan Bedah Minor. Datang ke lokasi Anda.">
    ...
    <style>
        ...
        .hero-ov {
            background: linear-gradient(to right, rgba(15, 39, 71, .92) 0%, rgba(15, 39, 71, .65) 55%, rgba(15, 39, 71, .1) 100%);
        }
